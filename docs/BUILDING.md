...
This process does not make the artifact production-ready. Every manual gate in `docs/FREE-V1-MUST-PASS.md` must still be completed in the claimed runtime matrix before shipment.
