...
| P0 setup/diagnostics | requirements, Site Health, setup checklist, REST/cache and queue smoke checks, proxy and backup controls, key-free mail test, secret-free report | Implementation, source contracts, and local runtime smoke complete; exact release-candidate browser and authorization rerun remains |
