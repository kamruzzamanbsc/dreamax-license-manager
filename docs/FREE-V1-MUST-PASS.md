...
| F32 | Audit compatibility | Event catalog/consumer tests | Versioned stable meanings and sanitized payloads | Central contract covers 44 production event types plus four non-persistable legacy names; emitter completeness, schema/actor/reference/metadata validation, fixtures, legacy-read compatibility, and recursive redaction tests pass locally. Live WordPress/MySQL/privacy/multisite transaction evidence remains open. | `docs/AUDIT-EVENTS.md`, `docs/AUDIT-EVENT-CONSUMERS.md`, `docs/adr/0004-versioned-audit-event-contract.md`, `docs/release-evidence/0.3.0/f32-audit-event-contract.md`, `tests/Unit/AuditEventCatalogTest.php` | Windows 10 x64; PHP 8.2.4; Composer 2.8.5; no live WordPress/MySQL runtime | 2026-08-25 | Codex source/automated review | BLOCKED |
