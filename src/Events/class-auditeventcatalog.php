...
final class AuditEventCatalog {
	...
	public static function contracts(): array {
		...
		return array(
			...
			self::LICENSE_UPDATED                          => self::v1( array( 'api_credential' ), 'required', 'optional', 'optional', array( 'changed_fields' => 'string-list' ), array(), array( 'src/Api/class-privilegedroutes.php' ) ),
