<?php
/**
 * Defines the IdempotencyRepository class.
 *
...
/**
 * Handles Idempotency repository operations.
 */
final class IdempotencyRepository {
	 ...
	 *         code:string,
	 *         data:array{
	 *             license_public_id?:mixed,
	 *             product_public_id?:mixed,
	 *             activation_public_id?:mixed,
	 *             status?:mixed,
	 *             expires_at?:mixed,
	 *             replayed?:mixed,
	 *             activations?:mixed
	 ...
	 *
	 * @param array $value Value value.
	 * @phpstan-param array<string,mixed> $value Value value.
	 */
	...
	/**
	 * Handles the bounded result operation.
	 *
	 * @param array $data Data value.
	 * @phpstan-param array<string,mixed> $data Data value.
	 * @return array{
