<?php
/**
 * Defines the ExpiryPolicy class.
 *
...
/**
 * Handles Expiry policy operations.
 */
final class ExpiryPolicy {
	 ...
	 *
	 * @param ?string $current_expiry Current expiry value.
	 * @phpstan-param string|null $current_expiry Current expiry value.
	 * @param int     $extension_seconds Extension seconds value.
