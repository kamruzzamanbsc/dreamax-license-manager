<?php
/**
 * Defines the LicenseService class.
 *
...
/**
 * Creates and assigns encrypted license records.
 *
 * @phpstan-type LicenseResult array{id:int,public_id:string,key:string}
 */
final class LicenseService {
	...
	/**
	 * Handles the create generated operation.
	 *
	 * @param array $attributes Attributes value.
	 * @phpstan-param array<string,mixed> $attributes Attributes value.
	...
	/**
	 * Handles the assign pool operation.
	 *
