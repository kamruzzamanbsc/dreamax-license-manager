...
- Added guarded paid variable-product verification for two explicit variation identities and policies, with exact per-quantity/per-item allocation and full transaction rollback.
